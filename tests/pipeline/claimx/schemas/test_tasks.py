...
class TestClaimXEnrichmentTaskCreation:
    ...
    def test_create_with_required_fields(self):
        ...
        task = ClaimXEnrichmentTask(
            trace_id="evt_123", event_type="PROJECT_CREATED", project_id="proj_456",
...
class TestClaimXEnrichmentTaskValidation:
    ...
    def test_missing_trace_id_raises_error(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ClaimXEnrichmentTask(
                event_type="PROJECT_CREATED", project_id="proj_456",
                created_at=now, ingested_at=now,
            )
    ...
    def test_empty_trace_id_raises_error(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ClaimXEnrichmentTask(
                trace_id="", event_type="PROJECT_CREATED", project_id="proj_456",
                created_at=now, ingested_at=now,
            )
