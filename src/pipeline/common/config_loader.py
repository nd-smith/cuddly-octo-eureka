"""Shared configuration loading for app workers.

Loads YAML config files and connection definitions used by app workers.
"""
...
from pipeline.common.connections import AuthType, ConnectionConfig
