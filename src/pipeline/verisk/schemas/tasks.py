...
class XACTEnrichmentTask(BaseModel):
    ...
    raw_event: dict[str, Any] = Field(
        ...,
        description="Original raw event dict (type, version, utcDateTime, traceId, data) "
            ...
            "examples": [
                {
                    ...
                    "raw_event": {
                        "type": "verisk.claims.property.xn.paymentProcessorAssigned",
                        "version": 1,
                        "utcDateTime": "2024-12-25T10:29:00Z",
                ...
                },
                {
                    ...
                    "raw_event": {
                        ...
                        "version": 1,
                        "utcDateTime": "2024-12-25T10:59:00Z",
                        "traceId": "xyz789-abc123",
                        "data": '{"assignmentId": "B67890"}',
                    },
                },
            ]
        }
...
class DownloadTaskMessage(BaseModel):
    ...
    Schema matches verisk_pipeline.verisk.xact_models.Task for compatibility.
    ...
    is_reinspection: bool = Field(
        default=False,
        description="True if this estimatePackageReceived event contains a REINSPECTION_FORM.XML attachment",
    )
    ...
    def to_verisk_task(self) -> "Task":
        ...
        Returns:
            pipeline.verisk.schemas.models.Task instance
        """
        from pipeline.verisk.schemas.models import Task
    ...
    def from_verisk_task(cls, task: "Task") -> "DownloadTaskMessage":
        ...
        Args:
            task: verisk_pipeline.verisk.xact_models.Task instance
