...
Uses flatten_events() from pipeline.verisk.writers.transform.
...
from pipeline.verisk.writers.transform import flatten_events
...
class DeltaEventsWriter(BaseDeltaWriter):
    ...
    Uses flatten_events() from pipeline.verisk.writers.transform to transform
    ...
    Output schema matches pipeline.verisk.writers.transform.FLATTENED_SCHEMA:
