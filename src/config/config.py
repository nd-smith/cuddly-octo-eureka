...
def load_config(
    ...
    verisk_config = pipeline_config.get("verisk") or {}
    claimx_config = pipeline_config.get("claimx") or {}

    storage = pipeline_config.get("storage") or {}
    ...
    logging_config = yaml_data.get("logging") or {}
